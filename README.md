<!-- badges: start -->
[![R-CMD-check](https://github.com/bips-hb/RFAE/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/bips-hb/RFAE/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
# Python Library
The Python version of RFAE is available at [RFAE_py](https://github.com/binhducvu/RFAE_py)

# References
- Vu, B. D., Kapar, J., Wright, M., & Watson, D. S. (2025). Autoencoding Random Forests. arXiv preprint arXiv:2505.21441. Link [here](https://arxiv.org/abs/2505.21441)
